...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-cyan-500/20 bg-black/50 backdrop-blur-sm">
              ...
              {[
                ...
                return (
                  <a
                    key={index}
                    href={social.link}
                    className="group p-2 bg-cyan-500/10 border border-cyan-500/30 rounded-lg hover:border-cyan-500/50 hover:bg-cyan-500/20 transition-all"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index}>
                  <a href={item.link} className="text-gray-400 hover:text-cyan-400 transition-colors">
                    {item.label}
                  </a>
                </li>
              ))}
